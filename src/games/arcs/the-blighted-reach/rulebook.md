...
E.  Shuffle **2 Event action cards** (<span>2</span>–3 players) or **3 Event action cards** (4 players)into the action deck.
...
I.  Shuffle all **15 campaign****Vox and Guild** **cards** (marked "CC") to make the Court deck. Deal **3 cards** (<span>2</span> players) or **4 cards** (3–4 players) from it into the **Court****row**.
...
- Material and Fuel go on Tycoon. Weapons go on Warlord.
...
B.  Each player draws **2 "A" Fate cards** ("A" on card back) and chooses one secretly. After everyone chooses, reveal them and take the matching **Fate Sets** (page <span>2</span>).
...
B.  Shuffle the Court deck and deal **3 cards** (<span>2</span> players) or **4 cards** (3–4 players) from it into the Court. Flip the **Imperial Council card** to **In Session**.

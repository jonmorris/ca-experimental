...
<!-- FIDELITY-FLAG: source reads "Punch out the **24 Fate Set dividers** and put them in the deep box wells. Place" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "Each player has the following pieces. The box contains pieces for 4 players." — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
- Do not use ***setup cards***. No clusters will be out of play, and players place their starting pieces differently.

- Use the ***Guild and Vox cards*** specific to the campaign Court (marked “CC”). Do not use the cards for the base Court (marked “BC”).

- Use the same deck of ***lore cards*** as the base game (marked “L”), but you will shuffle lore into the Court deck after dealing the Court.
...
<!-- FIDELITY-FLAG: source reads "B.  Give the **initiative marker** to a random player. C.  Shuffle the **20 acti" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
B.  Give the **initiative marker** to a random player. C.  Shuffle the **20 action cards** marked “2” through “6” to start the **action deck**. D.  ***4 Players Only:*** Shuffle the **8 action cards** **marked “1” and “7”** into the action deck. E.  Shuffle **2 Event action cards** (2–3 players) or **3 Event action cards** (4 players)into the action deck. F.  Place the **3 ambition markers** on their blue, lower-numbered sides in the Available Markers section of the map. G. Place the **Chapter track tile** to cover the chapter track on the map, with its “Act I & II” side face up, and place the **chapter marker** on its “1” space. H. Place the **zero marker** in the Ambition Declared slot on the map.

I.  Shuffle all **15 campaign****Vox and Guild**  N. Roll the **number die**, then set up the **cards** (marked “CC”) to make the Court  **2 Imperial clusters**—in the rolled cluster deck. Deal **3 cards** (2 players) or **4 cards**  and the next clockwise cluster, place (3–4 players) from it into the **Court****row**. **1****Imperial ship** in each system. *(8 total.)* J.  Shuffle **1 lore card per player** at random O. Roll the **event die**. Place **1 Free city** from the lore deck into the Court deck.  on each planet of the rolled planet ID *Use the same lore deck as you use in*  symbol ***outside the Imperial clusters***. *the base game. You can add any lore* P.  Place **1 damaged Blight***(shaded side)* in *cards you want from expansion packs.* each system ***outside the Imperial clusters***. K.  Place the **Imperial Council card** ( 01) on its Q. ***2 Players Only:*** Place the **6 resource** **In Session** side as the leftmost Court card. **tokens** matching the planets in Imperial L.  ***2 Players Only:*** Slide the **Guild**  clusters onto the ambition boxes: **Envoys Depart edict card** ( 02) into

- Material and Fuel go on Tycoon. the first slot in the rules booklet.  Weapons go on Warlord. M. Shuffle the 3 **Govern the Imperial Reach**  • Relics go on Keeper. **edict cards** ( 03–05) face down, flip them  • Psionics go on Empath. all over, and slide them all face up into the first available slot in the rules booklet.

### 2. Set Up Players

<!-- FIDELITY-FLAG: source reads "A.  Each player chooses a color, collects If no one has the **First Regent tile*" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
A.  Each player chooses a color, collects If no one has the **First Regent tile** from their the **player board**, **15 ships**, **5 cities**,  setup, the player with initiative takes it. **5 starports**, and **10 agents** of that color, G. In turn order, each player places **3 ships** and places those cities in the 5 triangle and **1 building** in an empty building slot slots along the top of their player board. at a planet ***with an Imperial ship*** and B.  Each player draws **2 “A” Fate cards**   gains **1 resource token** of that planet (“A” on card back) and chooses one secretly.  type. *(The planet can have Rival pieces.)* After everyone chooses, reveal them and H. Repeat the previous step but in ***reverse*** take the matching **Fate Sets** (page 2). turn order—start with the last player in C.  Each player sets up based on the turn order and go counterclockwise. Setup side of their **objective card**—the I.  Place **Free cities** in all empty building first card in their Fate Set—then flips slots on planets with Imperial ships. *(With* the card to its Objective side. *4 players, you might not place any.)* D.  Each player places their **objective marker** J.  Each player draws **6 action cards** into on the Power track space shown by the their hand. ***2 Players Only:*** The player large clock on their objective card. without initiative may discard all of E.  Each player puts their **Power marker** on the action cards in their hand ***except*** the “0” Power track space on the map. ***Events*** and draw the same number of new cards from the action deck. F.  Each player takes a **Regent/Outlaw title** **card** ( 06–09) and tucks it partially under K.  Discard all **action cards** not in players’ hands their Fate card with its Regent side up.  into the action discard pile on the map.

*2 players only*

## Act II & III Setup {: #act-ii-and-iii-setup}

Set up Act II or III so it’s the same as the previous the planets in the 2 rolled clusters onto Act, including Power, with these changes: ambition boxes as in Step Q of Table Setup in Act I. *(If the resource supply* A.  In Act II, flip the lowest-Power **ambition** *empties, just place as much as you can.)* **marker** to its higher-Power side. In Act III, flip the two lowest-Power ones to F.  Each player sets up using the Setup side their higher-Power sides. The others of their **objective card**, then flips it to start on their lower-Power sides. its Objective side. Each player may also rearrange their **resource tokens**. If multiple B.  Shuffle the Court deck and deal players must make setup choices, resolve **3 cards** (2 players) or **4 cards** (3–4 them in turn order. *(To speed up setup,* players) from it into the Court. Flip the *feel free to do all this simultaneously!)* **Imperial Council card** to **In Session**. G. Each player places their **objective marker** C.  Place **1 damaged Blight** on each gate that has no Blight and no ships. on the Power track space as shown at the top of their objective card. In Act III, only D.  Roll the **event die**. In each cluster, place players with a “C” Fate do this step. **1 damaged Blight** at the planet with the H. Place the **Chapter track tile** on its side rolled ID symbol if it has no Blight. If it ***does*** that lists the current Act. Place the have Blight, place 1 damaged Blight at **chapter marker** on its “1” space. Draw ***each planet*** in its cluster with no Blight. and discard **action cards** exactly as in E.  ***2 Players Only:*** Roll the **number die** twice. steps J–K of Player Setup in Act I. Place the **6 resource tokens** matching

## The Campaign {: #the-campaign}

<!-- FIDELITY-FLAG: source reads "A campaign of *Arcs* lasts for three games, called **Acts**. Campaign Acts end d" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
A campaign of *Arcs* lasts for three games, called **Acts**. Campaign Acts end differently from single-session games.

- Don’t end an Act after 5 chapters***. Instead, Acts I and II end after ***3 chapters***, and Act III ends after ***4 chapters***.

- Don’t end an Act early if a player gains enough ***Power***. Ignore the thresholds on the Power track.

<!-- FIDELITY-FLAG: source reads "While setting up Act I, you choose an **”A” Fate**. You might play this Fate for" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "At the end of Act III, the winner is the player with the most Power ***accumulat" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "During setup, place your **objective marker** on the **starting** **space** on t" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "After Acts I and II, there is an **Intermission**. In it, you gain a bonus for c" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "In Act III, “A” or “B” Fates give two **grand ambitions**, shown by gold crossha" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "If you fulfilled one grand ambition, gain the lower amount of Power shown under " — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "Your grand ambitions are always active—you do not need to declare them. Rivals c" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
- If you have a final objective, you can still win at the end of Chapter 4 by simply having the most Power.

- If multiple players would win the game by completing their final objective, the winner is the player among them with the most Power.

### Rules Booklet

As you play, your Fate will add many cards to the **rules** **booklet**.

<!-- FIDELITY-FLAG: source reads "The booklet is double-sided. You can use one side for Edict cards and the other " — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "A Regent can become an **Outlaw** by calling a Summit (page 16). Outlaws can be " — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
- Empire control*** of gates ends the Catapult moves of Outlaw pieces, but not Regent or Imperial pieces.

- Regent control*** of gates ends the Catapult moves of Outlaw pieces and Rival Regent pieces alone, but not Imperial pieces or mixed Regent and Imperial pieces.
...
<!-- FIDELITY-FLAG: source reads "If the Empire is defending, the defending pieces are the Imperial ships in the b" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "During the **Edicts**, the First Regent governs the Empire. Over time, more Edic" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "Event cards are a new kind of action card added during setup. They cannot be scr" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
- If is rolled, resolve **Edicts** (page 20).
...
## Imperial Council {: #imperial-council}

<!-- FIDELITY-FLAG: source reads "The **Imperial Council** is a card in the Court with two sides: In Session and D" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
2.  If you’re a **Regent**, take the First Regent tile, keeping all resources on the Imperial Trust (page 21).

3.  If you’re an **Outlaw**, steal resources from the Imperial Trust on the First Regent tile, up to your number of empty resource slots. The First Regent loses 1 Power for each resource stolen.

4.  You must choose to resolve either the **Crises** (page 18) or the **Edicts** (page 20).
...
## The Free States {: #the-free-states}
...
<!-- FIDELITY-FLAG: source reads "Event cards and the Imperial Council let players call the Summit. It has two par" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
- Return Favors:** Return a Rival’s Favors to their supply to force them to take Negotiation actions (page 17) you choose, ***targeting******you***, in the way you choose. By default, each Negotiation action you force costs 1 Favor. **Petition the Council:** Flip the Imperial Council card to its In Session side.

- Leave the Empire:** Flip your Regent title card to Outlaw. If you are the First Regent, give the First Regent tile to the Regent with the most Power. Resources stay in the Imperial Trust. ***If there are no Regents***, return all resources from the Imperial Trust to the supply, lose 1 Power per resource returned, and place the First Regent tile in the supply.

- Revive the Empire:** If there are no Regents, flip your Outlaw title card to Regent and take the First Regent tile.

### Negotiations

After the Call to Order, ***all players*** may take any number of Negotiation actions listed below in a freeform manner.

<!-- FIDELITY-FLAG: source reads "Each Negotiation action affects a Rival. To take a Negotiation action, you need " — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
Each Negotiation action affects a Rival. To take a Negotiation action, you need the consent of the affected Rival.

- Cede Control:** Replace 1 Loyal piece on the map with 1 Rival piece of that type. You can only replace a Loyal building if no Loyal ships are in its system, and you cannot replace your last city, starport, or ship on the map. **Delegate Authority:** Replace 1 Loyal agent on a card in the Court with a Rival’s agent.
...
- Invite to Empire:*****If you’re the First Regent***, flip an Outlaw’s title card to Regent.
...
<!-- FIDELITY-FLAG: source reads "If no one is negotiating, the player who called the Summit may call for them to " — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "Event cards and the Imperial Council can trigger the Crises. When the Crises are" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "The Blight deals hits to Imperial ships first. If no Imperial ships remain, it d" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "Some Fates add cards with **Crisis** text that are held by players. Resolve all " — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "The Blight is a mysterious entity spreading through the Reach. No one knows what" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
The Blight is a mysterious entity spreading through the Reach. No one knows what it wants or how to communicate with it.

<!-- FIDELITY-FLAG: source reads "In Crises (page 18), the Blight hits ships. In the Intermission (page 28), it de" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
In Crises (page 18), the Blight hits ships. In the Intermission (page 28), it destroys buildings in systems with no ships.

- Harming & Trophies:** Blight can be **harmed**—battled, hit, damaged, and destroyed. However, it is ***Tough***—it takes 2 hits to damage or destroy. One hit does nothing. Take Blight that you destroy as Trophies. **Battling:** If you choose the Blight as defender in battle, all Blight in the battle system are defending pieces. Blight is hit with but not  . Blight does not intercept. **Catapult Movement:** Players taking a Catapult **move** must end it if they move into a gate with fresh or damaged Blight, like if a Rival controlled the gate.

- Empty Supply:** If you must place Blight but the supply is empty, take it from the player who has the most Blight Trophies.

## Edicts {: #edicts}

Event cards and the Imperial Council can trigger the Edicts.

<!-- FIDELITY-FLAG: source reads "Resolve all Edicts in order from lowest number to highest. The game starts with " — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
- If they **enforce** it, they collect the listed **Imperial **Demand** and then take the listed **Imperial Action**, as described through the rest of this section.

- If they **change** it, they choose a new Govern the Imperial Reach edict card to place on top of the other two cards.
...
- Peace:** Relics or Psionics **Escalation:** Material, Fuel, or Weapons
...
<!-- FIDELITY-FLAG: source reads "If a Rival Regent has no pieces shown by the Demand, the First Regent must take " — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "Some Fates give you a Flagship board, piece, and aid card. When you get a Flagsh" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "To **build** an Upgrade or Armor, your Flagship must be at a planet of the type " — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
- Players cannot **tax** these cities and cannot use these starports to **build** ships or Catapult **move**.

- Destroying these cities does not **Provoke **Outrage** or **Ransack the Court**.
...
- You must take hits from and with Upgrades and Armor if no other attacking ships remain.

- You can choose to take hits with Upgrades and Armor instead of other attacking ships.
...
<!-- FIDELITY-FLAG: source reads "Take each hit to your Flagship with your rightmost Armor. If no Armor remains, t" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
- Dice Collection:** Lore that collects dice for Loyal ships like in battle—like Galactic Rifles—lets your Flagship collect 1 die per fresh starport on your Flagship board.

### Flagship Upgrade Benefits

<!-- FIDELITY-FLAG: source reads "This section lists the Flagship’s Upgrades. The resource types in parentheses ar" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
1.  Clear your Flagship board and return it to the box. Replace your Loyal Flagship piece with a Loyal ship.

2.  Place 1 city and 1 starport in empty building slots on the map. If there are none, replace Free buildings.

3.  If you have fewer than 8 Loyal ships on the map, place ships in systems with Loyal pieces until you have 8 Loyal ships on the map.

## New Rules & Terms {: #new-rules-and-terms}
...
<!-- FIDELITY-FLAG: source reads "the Court that does not have an attached card." — possible column-break truncation — line starts mid-word or mid-sentence. Verify against physical source. -->
the Court that does not have an attached card.

<!-- FIDELITY-FLAG: source reads "When you **secure** a card, also secure its attached card. If both have When Sec" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "Many Fates add new punchboard **tokens**. By default, tokens added by Fates cann" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "By default, tokens added by Fates are not **Loyal**. However, some do say they a" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "The Intermission happens at the end of Act I and Act II. Resolve all of the foll" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
1.  Return all cards in the Court except the Imperial Council to the Court deck.
...
2.  Return all frozen resources (page 27), including from the Imperial Trust on the First Regent tile, to the supply.

3.  ***2 Players Only:*** Return all resources from ambition boxes to the supply.

### D. Repair & Destroy Pieces

1.  Repair all damaged Blight.

2.  Destroy all damaged ships, buildings, and Flagship Upgrades and Armor.

3.  Destroy all buildings in systems that have Blight and no ships.

**Wait to resolve this** **until the Intermission**

### E. Shift Initiative & Power

1.  Give the initiative marker to the player with the ***most Power***.

2.  Each player who has more than 1 Power ***loses half*** ***their Power***, rounding to lose less Power.
...
<!-- FIDELITY-FLAG: source reads "Each player who completed their objective draws 1 Fate card. Each player who fai" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
<!-- FIDELITY-FLAG: source reads "Each player secretly chooses 1 Fate card from these 2 Fate cards to play in the " — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->
...
- Scrap the rest of your Fate Set that is not ***in play.*** Don’t scrap anything that is in play, including your Flagship if you have one! ***Return all Favors*** you have to your Rivals.
...
- Use a ***log sheet*** to record your names, colors, Fates, Power, Outrage, and Flagship Upgrades and Armor. If a Fate has you record more details, use the blank spaces on the back of the log sheet.

- Use the ***2 map trays*** to store the pieces on the map. The trays have sections for each planet (marked with its ID symbol) and each gate (marked “G”).

- If a system has too many pieces to fit in the tray, put an ***overflow marker***in its tray section and put pieces from the system in a bag with the matching overflow marker.

- Use the ***4 player trays*** to store the players’ play areas. In your tray, use the large well to hold cards in play stacked on top of the cards remaining in your Fate Set. Use the small well to hold everything else in your play area except your player board and Flagship board. You don’t need to track the order of your resources. Keep all of the cards in the ***rules booklet***.
...
- Use dividers in these wells to store unused Fate Sets, the action deck, base and campaign Court decks, lore deck, small cards from the base game, and scrapped cards.

- You may store the bags of pieces for Fate Sets with their cards behind their divider or in a separate well. If you sleeve cards, store the piece bags in a separate well.

- Stack the game board, player boards, and Flagship boards on top of the lower wells.

The ***deep well*** stores the ***8 removable trays***: 4 player trays, 2 map trays, the base game tray, and the campaign game tray.

<!-- FIDELITY-FLAG: source reads "The base game and campaign trays can be packed in many ways, but we recommend yo" — possible two-column interleave — multiple sentences on one line. Verify against physical source. -->

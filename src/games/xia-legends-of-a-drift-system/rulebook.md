...
## Overview: Become a Legend {: #overview-become-a-legend}
...
<!-- FIDELITY-FLAG: source reads "no markers should be lefton any Outfits" — "lefton" appears to be "left on" with a lost space (OCR/conversion artifact). Preserved verbatim. -->
...
<!-- FIDELITY-FLAG: source reads "at least one Sector tile leftin the deck" — "leftin" appears to be "left in" with a lost space (OCR/conversion artifact). Preserved verbatim. -->
...
<!-- FIDELITY-FLAG: source reads "dropofflocations" — appears to be "drop-off locations" with spaces lost (OCR/conversion artifact). Preserved verbatim. -->
...
## Capitalism: Cargo Cubes and Credits {: #capitalism-cargo-cubes-and-credits}
...
## Non-Player Ships {: #non-player-ships}

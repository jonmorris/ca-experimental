...
## 1.3 Factory Mat and Markers {: #1-3-factory-mat-and-markers}
...
## 1.4 Harbor Mat (Warehouse/Contracts) {: #1-4-harbor-mat-warehouse-contracts}
...
## 1.6 Wooden Components {: #1-6-wooden-components}
...
## 1.8 Development Tiles {: #1-8-development-tiles}
...
## 1.9 Event Markers {: #1-9-event-markers}
...
## 2. Strategy Tips {: #2-strategy-tips}
...
## 2.1 The Specialist {: #2-1-the-specialist}
...
## 2.2 The Shipowner {: #2-2-the-shipowner}
...
## 2.3 The Completist {: #2-3-the-completist}
...
## 2.4 The Flexible Player {: #2-4-the-flexible-player}
...
## 3.3 Stock Exchange {: #3-3-stock-exchange}
...
5. Reduce share value for open contracts and remaining workers on a factory 6. Evaluate final score and winner
...
mber of shares and current share value

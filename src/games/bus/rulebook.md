...
### 3-Player Game: Only Use 4 Time Stones.
...
## The First Buildings {: #the-first-buildings}
...
## Choosing Actions {: #choosing-actions}
...
## The Maximum Number of Buses {: #the-maximum-number-of-buses}
...
## Starting Player & The Next Round {: #starting-player-and-the-next-round}
...
- The game ends at the end of a round if, at that moment, only one player has any action markers left to play.
- The game ends at the end of a round if there are no more free building locations.
...
## Playing with 5 Players {: #playing-with-5-players}
